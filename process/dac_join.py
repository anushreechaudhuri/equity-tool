...
os.chdir(RAW)
qct = pd.read_csv("qct.csv", dtype=str)
...
# Load DAC files
os.chdir(SQL_OUTPUT)
dac_pct = pd.read_csv("dac_pct.csv", dtype=str)
dac_shp = gpd.read_file("MappingDisplay_Data.geojson")
tt_shp = gpd.read_file("MappingDisplay_TribesAndTerritories.geojson")
...
# os.chdir(REPORT)
# dac.to_file("dac.geojson", driver="GeoJSON")

# Export to geojson file in REPORT
os.chdir(CARTO)
dac.to_file("carto_dac.shp", driver="ESRI Shapefile")
...
# os.chdir(REPORT)
# tt_shp.to_file("tt_shp.geojson", driver="GeoJSON")
# os.chdir(CARTO)
# tt_shp.to_file("tt_shp.geojson", driver="GeoJSON")

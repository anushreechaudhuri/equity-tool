...
st.set_page_config(page_title="Welcome", page_icon=None, layout="wide", initial_sidebar_state="auto", menu_items={
...
dac_def = pd.read_excel("data_definitions.xlsx", sheet_name="CensusTracts", index_col=False)
nhpd_def = pd.read_excel("data_definitions.xlsx", sheet_name="NHPD", index_col=False)
